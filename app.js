(() => {
  ...
  async function loadAll() {
    ...
    try {
      ...
      const { customers, drivers, fleet, fuelLogs, maintenance, recurringJobs, quotes, jobs, invoices, expenses, portalBookings, portalAccessUsers, routeStops, quoteRequests, settings } = loaded;
