...
(() => {
  ...
  function profileView(){
    return `<section class="profile-screen">
      ...
      <button class="btn secondary full" data-driver-tab="incident">Report an incident</button><button class="btn secondary full" data-toggle-dark>${state.darkMode?'Use light mode':'Use dark mode'}</button><a class="btn secondary full" href="/driver-privacy.html" target="_blank" rel="noopener">Privacy & GPS notice</a><a class="btn secondary full" href="https://kingslogisticsservices.co.uk/privacy-notice/" target="_blank" rel="noopener">Customer privacy notice</a>${state.isOfficeOwner?'<a class="btn primary full owner-office-link" href="/">Back to KLS Office</a>':''}<button class="btn secondary full profile-signout" data-signout>Sign out</button>
    </section>`;
  }
